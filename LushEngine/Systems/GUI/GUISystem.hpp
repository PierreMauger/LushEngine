...
namespace Lush
{
    ...
    class GUISystem : public ASystem
    {
        private:
            ...
            void deleteEntity(std::shared_ptr<EntityManager> &entityManager, std::size_t id, Entity &entity);
            bool drawEntityInSceneHierarchy(std::shared_ptr<EntityManager> &entityManager, std::size_t id, Entity &entity);
